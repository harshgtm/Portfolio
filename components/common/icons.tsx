import BullIcon from "@/assets/fonts/svg/Bull";
import Git from "@/assets/fonts/svg/Git";

import RabbitMQIcon from "@/assets/fonts/svg/RabbitMQ";
import {
  AlertTriangle,
  ArrowRight,
  BookMarked,
...
export const Icons = {
  ...
  bullmq: ({ ...props }: LucideProps) => (
    <div className="svg-container">
      <BullIcon {...props} height={props.size} width={props.size} />
    </div>
  ),
  rabbitmq: ({ ...props }: LucideProps) => (
    <div className="svg-container">
      <RabbitMQIcon {...props} height={props.size} width={props.size} />
    </div>
  ),
  git: ({ ...props }: LucideProps) => (
    <div className="svg-container">
      <Git {...props} height={props.size} width={props.size} />
    </div>
  ),
  retro: Palette,
  cyberpunk: Zap,
